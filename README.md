...
[Запуск](#быстрый-запуск) · [Возможности](#шесть-экранов-один-процесс-закупки) · [ML](#два-метода-прогноза) · [Демо](docs/demo.md) · [Проверки системы](docs/system-verification.md) · [Документация](#документация-и-команда)
