...
| **Ассистент** | Поиск обычными словами, рекомендации по заказу, новинки, угасающий спрос и кандидатов на замену товара. |
