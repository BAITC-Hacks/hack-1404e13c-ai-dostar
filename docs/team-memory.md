...
- Документация обновлена не полностью: `docs/methodology-demand.md` ещё описывает отсутствие сезонности в pipeline, `docs/tasks.md` у выполненной 2.4 пишет, что тест ждёт 1.2. Информация об интеграции в этом разделе исправлена. UI по-прежнему содержит только таблицы и переключатель мок/реальные; кнопки copilot, правки, утверждение и экспорт в него ещё не подключены.
