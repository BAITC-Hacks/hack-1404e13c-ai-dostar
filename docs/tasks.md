...
- [ ] **2.4 Приемка** `tests/test_acceptance.py`, на реальных данных через `pipeline.run`:
...
- [ ] **3.9 (если есть время)** `app/copilot.py` — «Объяснить подробнее» по строке через LLM: на вход только числа строки, fallback на `rationale`.
